//! Cross-implementation crypto compatibility tests.
//!
//! Asserts that poof-crypto's Poseidon is bit-identical to circomlib's, and
...
use poof_crypto::{fr_from_u64, hash2, hash3, hash4, Keypair, Note};
...
fn matches_light_poseidon_reference() {
    ...
    for inputs in [
        ...
        let ours = poof_crypto::hashn(&inputs);

//! Local note management: a [`StoredNote`] (a `veil_crypto::Note` plus its tree
...
//! deliberately simple (a `Vec`); persistence is a Phase-2 concern. The contract
//! is always the final arbiter of spent-ness — this store is an optimistic local
//! cache (CLAUDE.md edge case: "Proof generated against a note already spent").

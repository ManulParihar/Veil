//! # veil-sdk — PLANE 4a: the client library
//!
//! Off-chain note management for the Veil shielded pool: key derivation, a local
...
//! snarkjs proving shim. It depends on `veil-crypto` for all Poseidon/note math —
...
impl Wallet {
    ...
    /// to self. Phase-1: `publicAmount = 0`, `fee = 0`, no relayer.
    ///

...
//!   * parent = `veil_crypto::compress(left, right)` = `Poseidon(left, right)`;
//!   * empty subtrees from `veil_crypto::zero_leaf` (`Zero(0)=Poseidon(0)`,
...
use ark_bn254::Fr;
use veil_crypto::{compress, zero_leaf};
